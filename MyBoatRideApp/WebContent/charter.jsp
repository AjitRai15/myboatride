        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <div class="well-left">
            <div class="single-well">
              <a href="#">
								  <img src="img/about/charter_boat.png" alt="">
								</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <div class="well-middle">
            <div class="single-well">
              ...
              <p class="sec-head">
                MyBoatRide Charter is service that allows you to hire an exclusive Yacht or a Boat being used for a particular time or a destination port. The vessel is used exclusively for you and your family or friends. You could choose your yacht or a boat on the basis of the customer reviews available to be sure for your luxurious travel experience. </p>  
 
<p>How do you book a MyBoatRide Charter?</p>
 
<p>Step 1:- Login into your MyBoatRide Account</p>
<p>Step 2:- Enter your travel details.</p>
<p>Step 3:- Choose the 'Charter' option and search for the boat</p>
