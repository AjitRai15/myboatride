...
<!-- Check Email End -->
 ...
 <!-- Start About area -->
  ...
  <div class="panel-heading fs18 white" style="background:#3ec1d5;">Q. How to get started as a vendor?</div>
  <div class="panel-body"><p=""><strong>Ans.</strong> MyBoatRide has designed really simple steps to monetise your boats. Register on MyBoatRide.com as a vendor and complete your trust and verification. Then you can proceed with listing your Boat details in "ADD NEW BOAT" form and submit the complete form and send it for verification. Once verified we activate your boat and allow you to make your own package under the category that you fine suitable and price it as you want it to be. <p></p></div>
</div>
       
       <div class="panel panel-default">
  <div class="panel-heading fs18 white" style="background:#3ec1d5;">Q. Who is a Vendor?</div>
  <div class="panel-body"><p=""><strong>Ans.</strong> A person who list boats on myboatride.com is a vendor. He could be an agent, employee, or the real owner of the boat.<p></p></div>
</div>
  ...
  <ul class="pagination">
     <li class="page-item"><a class="page-link" href="5.jsp">Previous</a></li> 
   	<li class="page-item"><a class="page-link" href="5.jsp">5</a></li>
   	<li class="page-item"><a class="page-link" href="6.jsp">6</a></li>
   	<li class="page-item"><a class="page-link" href="7.jsp">7</a></li>
   	<li class="page-item"><a class="page-link" href="7.jsp">Next</a></li>
  </ul>
</nav>
