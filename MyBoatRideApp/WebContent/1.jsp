...
<!-- Check Email End -->
 ...
 <!-- Start About area -->
  ...
  <div class="panel-heading fs18 white" style="background:#3ec1d5;">Q. Are the price displayed the final price?</div>
  <div class="panel-body"><p=""><strong>Ans.</strong> Yes, the prices displayed on the ride detail page are all inclusive (tax &amp; convenience charge) &amp; is exactly what the customer pays. <p></p></div>
</div>
       
       <div class="panel panel-default">
  <div class="panel-heading fs18 white" style="background:#3ec1d5;">Q. How do i know if the service of a vendor is good or not?</div>
  <div class="panel-body"><p=""><strong>Ans.</strong> Our customer past experience helps you judge the quality of service of a vendor. Our customers give a review to the ride and accordingly the vendor service is rated.<p></p></div>
</div>
  ...
  <ul class="pagination">
   <!--   <li class="page-item"><a class="page-link" href="#">Previous</a></li> -->
    <li class="page-item"><a class="page-link" href="1.jsp">1</a></li>
    <li class="page-item"><a class="page-link" href="2.jsp">2</a></li>
    <li class="page-item"><a class="page-link" href="3.jsp">3</a></li>
    <li class="page-item"><a class="page-link" href="4.jsp">Next</a></li>
  </ul>
</nav>
