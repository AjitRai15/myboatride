...
<ul class="nav nav-tabs">
   <!--  <li class="active"><a data-toggle="tab" href="#home">Home</a></li>  -->
    <li><a data-toggle="tab" href="#menu1">Review About Me</a></li>
    <li><a data-toggle="tab" href="#menu2">Review About Customer</a></li>
  ...
  <div class="tab-content">
    ...
    <div id="menu1" class="tab-pane fade">
      <h3>Past Reviews</h3>
      <p>Reviews are written at the end of a reservation through MyBoatRide. Reviews you´ve received will be visible both here and on your public profile.

No one has reviewed you yet.</p>
    </div>
    <div id="menu2" class="tab-pane fade">
      <h3>Reviews to Write</h3>
      <p>Nobody to review right now.</p>
    </div>
          ...
          <footer class="main-footer d-flex p-1 px-3 bg-white border-top padding">
            <ul class="nav">
              <li class="nav-item">
