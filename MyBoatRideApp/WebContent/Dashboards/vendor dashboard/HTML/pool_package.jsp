          ...
          <div class="main-content-container container-fluid px-4">
            ...
            <div class="page-header row no-gutters py-4">
              <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                ...
                <h3 class="page-title">Pool Package</h3>
              </div>
            </div>
            <!-- End Page Header -->
            <div class="row">
              <div class="col-lg-9 col-md-12">
                ...
                <div class="card card-small mb-3">
                  <div class="card-body">
                    <form method="post" action="/MyBoatRideApp/AddpoolServlet" form class="add-new-post">
                    <label>Name/Header*</label>
                      <input class="form-control form-control-lg mb-3" type="text" name="name" placeholder="Name/Header" required>
               		...
               		<div class="form-row">
                            ...
                            <label>Want to except*</label>
      						<textarea class="form-control" name="expect" rows="5"></textarea>
                    ...
                    <div class="form-group">
								...
								<div class="row">
																<div class="col-sm-6">
                              <label><input type="checkbox" name="poolboatrules" value="Pets Not Allowed">Pets Not Allowed</label>
							  </div>
                               								<div class="col-sm-6">
                              <label><input type="checkbox" name="poolboatrules" value="Smoking Not Allowed">Smoking Not Allowed</label>
							  </div>
                               								<div class="col-sm-6">
                              <label><input type="checkbox" name="poolboatrules" value="Drugs Not Allowed">Drugs Not Allowed</label>
							  </div>
                               								<div class="col-sm-6">
                              <label><input type="checkbox" name="poolboatrules" value="Alcohol Not permitted">Alcohol Not permitted</label>
							  </div>
                               								<div class="col-sm-8">
                              <label><input type="checkbox" name="poolboatrules" value="Compulsory to wear a Life Jacket">Compulsory to wear a Life Jacket</label>
							  </div>
                        			</div>
                    ...
                    <div class="form-row">
                                ...
                                <select id="feInputState" name="cancel_policy" class="form-control" required>
                                  <option selected>select</option>
                    ...
                    <div class="form-row">
                                ...
                                <select id="feInputState" name="from_port" class="form-control" required>
                                  <option selected>select</option>
                    ...
                    <div class="form-row">
                    	 	...
                    	 	<div class="form-row">
                                ...
                                <select id="duration_of_a_ride" name="duration_ride" class="form-control" required>
                                  <option selected>select</option>
                              					...
                              					<label for="duration_of_a_ride">Day/Hour/Minute*</label>
                               					 <select id="duration_of_a_ride" name="time" class="form-control" required>
                                  							<option selected>select</option>
                    ...
                    <div class="form-row">
                                ...
                                <select id="close_the_Booking" name="close_booking" class="form-control" required>
                                  <option selected>select</option>
    		    ...
    		    <input type="date" class="form-control" id="datepicker" name="start_date" placeholder="Choose">
    		
    		</div>
    		
    		<div class="form-group col-md-4">
    			<label for="feDescription">End Date*</label>
    		    <input type="date" class="form-control" id="datepicker" name="end_date" placeholder="Choose">
    		</div>
