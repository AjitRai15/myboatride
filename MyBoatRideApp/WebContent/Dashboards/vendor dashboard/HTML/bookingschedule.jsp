            ...
            <div class="page-header row no-gutters py-4">
              <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
               <!--  <span class="text-uppercase page-subtitle">Overview</span> -->
                <h3 class="page-title">Booking Schedule</h3>
              </div>
            </div>
            <!-- End Page Header -->
            <!-- Default Light Table -->
              ...
              <div class="col-lg-8">
                      ...
                      <div class="row">
                        <div class="col">
                          ...
                          <!--  <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                <label for="feInputState">Booking Type*</label>
                                <select id="feInputState" name="country" class="form-control" required>
                                  <option selected>Choose...</option>
                                 
							 								 <option value="Afghanistan">Completed Booking</option>
							   								 <option value="Albania">Upcoming Booking</option>
    			...
    			<label for="feDescription">Date*</label>
