                        ...
                        <div class="col">
                          ...
                          <!--  <div class="form-row">
                            ...
                            <div class="form-group col-md-8">
                                ...
                                <input type="text" class="form-control" id="Old_Password" name="old_password" placeholder="Old Password" value="" required> </div>
                             
                             <div class="form-group col-md-8">
                                <label for="New_Password">New Password*</label>
                                <input type="text" class="form-control" id="New_Password" name="new_password" placeholder="New Password" value="" required> </div>
                    		
                    		<div class="form-group col-md-8">
                                <label for="Confirm_Password">Confirm Password*</label>
                                <input type="text" class="form-control" id="Confirm_Password" name="confirm_password" placeholder="Confirm Password" value="" required> </div>
