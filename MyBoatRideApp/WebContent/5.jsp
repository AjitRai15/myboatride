...
<!-- Check Email End -->
 ...
 <!-- Start About area -->
  ...
  <div class="panel-heading fs18 white" style="background:#3ec1d5;">Q. Does a Vendor have to own the Boat?</div>
  <div class="panel-body"><p=""><strong>Ans.</strong> No the Vendor does not have to own the boat but has the right by the owner of the boat in writing to market the boat and collect money on behalf of the owner. The vendor would take complete responsibility of the deliverable and safety of the passenger. <p></p></div>
</div>
       
       <div class="panel panel-default">
  <div class="panel-heading fs18 white" style="background:#3ec1d5;">Q. How do I list my Boat?</div>
  <div class="panel-body"><p=""><strong>Ans.</strong> Go to "ADD NEW BOAT" and click on "add new boat" button. Fill the boat details carefully and submit it once complete and then your boat goes for verification.<p></p></div>
</div>
  ...
  <ul class="pagination">
     <li class="page-item"><a class="page-link" href="4.jsp">Previous</a></li> 
