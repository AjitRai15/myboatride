      ...
      <div class="row">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="well-middle">
           ...
           <p style="text-align:justify"><strong>My Boat Ride</strong> follows a strict Refund Policy that has been made to ensure that you as a User do not have any problems and have a seamless experience with our Services.</p>
           <p style="text-align:justify">As per the Services provided by the Website, Users are able to view a variety of water travel experiences of different types, across the world. All water travel experiences are owned and operated by third-party Vendors, and Users are aware that payment terms for every water travel experience are decided entirely at the discretion of the third-party Vendors. Therefore, within the cancellation policy parameters set by the Website, the refund policies of the different Vendors shall vary as per their discretion and requirements.</p>
           <p style="text-align:justify">Every third-party Vendor has to choose a type of cancellation policy, in accordance with which refunds of Users are processed. Please note the following points with regards to the cancellation policy parameters:</p>
           
           <ol>
 <li style="text-align:justify"><strong>Flexible</strong> - This entitles the User to a 100 per cent refund, and MyBoatRide shall deduct 5 per cent from the User by way of a processing fee at the time of cancellation</li>
 <li style="text-align:justify"><strong>Moderate</strong>- This entitles the User to a 50 per cent refund and MyBoatRide shall deduct 5 per cent from the User by way of a processing fee at the time of cancellation</li>
 <li style="text-align:justify"><strong>Strict</strong>- This entitles the User to no refund, and MyBoatRide shall apply a surcharge of 5 per cent from the User by way of a processing fee at the time of cancellation</li>
 </ol>
 
 <p style="margin-left:0.25in; text-align:justify">The above-mentioned policies of the Vendors shall automatically convert to 'Strict' (mentioned in point 3 above) 24 hours prior to the date of the particular booking by any Use, regardless of the initial policy chosen by the Vendors at the time of registration with the Website.</p> 
    
  <p style="margin-left:0.25in; text-align:justify">Refunds shall be processed within 4 working days from the date of cancellation by the User, and amounts (as applicable) should reach the bank account of the User within 7 working days from the date of cancellation.</p>
 		
 	<ul style="list-style-type:circle">
 <li style="text-align:justify">Please note that in the above, any action shall take place only if the same has been informed to Us as mentioned above.</li>
 <li style="text-align:justify">Please make sure the email sent to us or the phone call/WhatsApp message contains all details so that we may examine the same.</li>
</ul>
<p style="text-align:center">&nbsp;</p>
                      
 <p style="text-align:justify">The Company have the sole discretion to assess each case on its own, separately.</p>
