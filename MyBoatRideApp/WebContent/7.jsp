...
<!-- Check Email End -->
 ...
 <!-- Start About area -->
  ...
  <div class="panel-heading fs18 white" style="background:#3ec1d5;">Q. Who is MyBoatRide.com?</div>
  <div class="panel-body"><p=""><strong>Ans.</strong> MyBoatRide.com is a marketplace for people to list, discover, and book Water Travel Experiences around the world on a single platform. <p></p></div>
</div>
  ...
  <ul class="pagination">
     <li class="page-item"><a class="page-link" href="6.jsp">Previous</a></li> 
