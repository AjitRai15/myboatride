      ...
      <div class="row">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <div class="well-left">
            <div class="single-well">
              <a href="#">
								  <img src="img/about/founder1.jpg" alt="">
								</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <div class="well-middle">
            <div class="single-well">
              <a href="#">
                <h4 class="sec-head">MyBoatRide.com is founded by a group of entrepreneurs.</h4>
              	<h4 class="sec-head">Navjyot Singh Oberai : Founder</h4>
              </a>
              <p>
                Originally from Delhi, India has done his schooling from G.D.Goenka Public School and Bachelors in Technology from Bharati Vidhyapeeth's college of Engineering in the field of Instrumentation and Control Engineering. Has a diverse experience in edibil oil, printing & food tech.

											At MyBoatRide.com heads the operations.
