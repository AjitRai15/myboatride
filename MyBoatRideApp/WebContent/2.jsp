...
<!-- Check Email End -->
 ...
 <!-- Start About area -->
  ...
  <div class="panel-heading fs18 white" style="background:#3ec1d5;">Q. Who decides the cost of a ride?</div>
  <div class="panel-body"><p=""><strong>Ans.</strong> The Boat owners price the boats. <p></p></div>
</div>
       
       <div class="panel panel-default">
  <div class="panel-heading fs18 white" style="background:#3ec1d5;">Q. Who decides the schedule & pricing of the activities?</div>
  <div class="panel-body"><p=""><strong>Ans.</strong> The Schedule of the Boats, the activities are priced by the vendor.<p></p></div>
</div>
  ...
  <ul class="pagination">
     <li class="page-item"><a class="page-link" href="1.jsp">Previous</a></li> 
   <!--  <li class="page-item"><a class="page-link" href="1.jsp">1</a></li>  -->
    ...
    <li class="page-item"><a class="page-link" href="5.jsp">Next</a></li>
  </ul>
</nav>
