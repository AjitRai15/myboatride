...
<!-- Check Email End -->
 ...
 <!-- Start About area -->
  ...
  <div class="panel-heading fs18 white" style="background:#3ec1d5;">Q. Can i book a seat on a boat?</div>
  <div class="panel-body"><p=""><strong>Ans.</strong> Yes, you can book a seat under a pool rides which allows customer to book a single seat on a boat or a yacht or a public transport. <p></p></div>
</div>
       
       <div class="panel panel-default">
  <div class="panel-heading fs18 white" style="background:#3ec1d5;">Q. Can i charter / hire a full boat?</div>
  <div class="panel-body"><p=""><strong>Ans.</strong> Yes, you can charter / hire a full boat if available. You can search for just charter in the search bar on the home page.<p></p></div>
</div>
  ...
  <ul class="pagination">
     <li class="page-item"><a class="page-link" href="3.jsp">Previous</a></li> 
